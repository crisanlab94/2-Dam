...
public class InicioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // --- SECCIÓN AÑADIDA: TUTOR IA ---
        findViewById(R.id.btnNavTutor).setOnClickListener(v -> {
            Log.d("STUDY_MATCH_DEBUG", "Abriendo el Tutor Pedagógico");
            Intent intent = new Intent(InicioActivity.this, TutorActivity.class);
            startActivity(intent);
        });
        // ---------------------------------
