...
import java.io.BufferedReader;       // Para leer texto del servidor
import java.io.FileReader;           // Para leer el fichero con números pares
...
public class ClientePar implements Runnable { // Clase que se ejecuta en un hilo independiente
    ...
    public void run() { // Método principal del hilo
        ...
        try {
            ...
            BufferedReader fichero = new BufferedReader(new FileReader("par.txt")); 
            // Abre el fichero que contiene los números pares
            ...
            while (seguir && linea != null) { 
                ...
                System.out.println("CLIENTE PAR: recibido -> " + mensaje); 
                // Muestra el mensaje recibido

                System.out.println("CLIENTE PAR: envío -> " + linea); 
            ...
            System.out.println("CLIENTE PAR ERROR: " + e.getMessage()); 
