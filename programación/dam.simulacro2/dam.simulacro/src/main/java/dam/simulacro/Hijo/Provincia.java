...
public class Provincia {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String contenidoProvincia=p.analizaProvincia(rutaResources, "SEVILLA.txt");
			   
			// Escribe el contenido en un fichero con el nombre de la provincia
            p.escribirProvincia(contenidoProvincia, rutaResources + "Sevilla" + ".txt");
            
            System.out.println(p.devuelveNumProvincia(rutaResources + "Sevilla" +".txt"));
